...
class About(models.Model):
    ...
    imagem_texto_um_about = models.ImageField(
        upload_to='imagens_about/imagens_texto_um', blank=True, null=True, default=None, verbose_name='Imagem do quadrado 1 (400x500)')
    imagem_texto_dois_about = models.ImageField(
        upload_to='imagens_about/imagens_texto_dois', blank=True, null=True, default=None, verbose_name='Imagem do quadrado 2 (400x500)')
    imagem_texto_tres_about = models.ImageField(
        upload_to='imagens_about/imagens_texto_tres', blank=True, null=True, default=None, verbose_name='Imagem do quadrado 3 (400x500)')
